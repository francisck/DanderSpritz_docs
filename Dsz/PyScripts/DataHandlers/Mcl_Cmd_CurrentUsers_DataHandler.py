...
# Embedded file name: Mcl_Cmd_CurrentUsers_DataHandler.py
...
def DataHandlerMain(namespace, InputFilename, OutputFilename):
    ...
    mcl.imports.ImportNamesWithNamespace(namespace, 'mca.status.cmd.currentusers', globals())
    ...
    while msg.GetNumRetrieved() < msg.GetCount():
        ...
        if data.loginTime.GetTimeType() != data.loginTime.MCL_TIME_TYPE_INVALID:
