...
# Embedded file name: ccompiler.py
"""distutils.ccompiler
...
def customize_compiler(compiler):
    ...
    if compiler.compiler_type == 'unix':
        cc, cxx, opt, cflags, ccshared, ldshared, so_ext, ar, ar_flags = _sysconfig.get_config_vars('CC', 'CXX', 'OPT', 'CFLAGS', 'CCSHARED', 'LDSHARED', 'SO', 'AR', 'ARFLAGS')
        if 'CC' in os.environ:
            cc = os.environ['CC']
