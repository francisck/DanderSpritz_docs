...
class Result:
    ...
    def Marshal(self, mmsg):
        ...
        submsg.AddStringUtf8(MSG_KEY_RESULT_VARIABLE, self.__dict__['variable'])
    ...
    def Demarshal(self, dmsg, instance=-1):
        ...
        self.__dict__['action'] = submsg.FindU8(MSG_KEY_RESULT_ACTION)
        self.__dict__['variable'] = submsg.FindString(MSG_KEY_RESULT_VARIABLE)
