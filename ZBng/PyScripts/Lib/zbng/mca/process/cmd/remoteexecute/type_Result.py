...
class Result:
    ...
    def __init__(self):
        ...
        self.__dict__['returnValue'] = 0

    def __getattr__(self, name):
        if name == 'processId':
            return self.__dict__['processId']
        if name == 'returnValue':
            return self.__dict__['returnValue']
    ...
    def __setattr__(self, name, value):
        if name == 'processId':
            ...
            self.__dict__['returnValue'] = value
        else:
            raise AttributeError("Attribute '%s' not found" % name)
    ...
    def Marshal(self, mmsg):
        ...
        submsg.AddU32(MSG_KEY_RESULT_RETURN_VALUE, self.__dict__['returnValue'])
    ...
    def Demarshal(self, dmsg, instance=-1):
        ...
        self.__dict__['returnValue'] = submsg.FindU32(MSG_KEY_RESULT_RETURN_VALUE)